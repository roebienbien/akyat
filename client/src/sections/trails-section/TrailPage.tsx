        ...
        <div className="grid lg:grid-cols-3">
          <div className="col-span-2 flex h-screen max-h-screen w-[95%] flex-col gap-y-2 md:gap-y-10">
            ...
            <div className="grid grid-cols-2 gap-6">
              {TrailInfo.map((trail, index) => (
                <div key={index} className="flex items-center gap-x-6 text-2xl text-gray-700">
                  {trail.icon}
                  <div className="flex flex-col">
                    <span className="text-base font-medium">{trail.value}</span>
                    <span className="col-start-2 text-xs text-gray-500">{trail.label}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col gap-y-4 text-justify lg:max-w-[740px]">
              ...
              <span className="flex flex-col gap-y-4">
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto quis ex quisquam vel eius maxime error neque excepturi atque facere.
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat est debitis labore deleniti unde voluptatibus aliquid iste illum
                  nemo praesentium?
                </p>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto quis ex quisquam vel eius maxime error neque excepturi atque facere.
