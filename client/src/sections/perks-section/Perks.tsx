...
export default function Perks() {
  return (
    <div id='about' className=' my-20 flex flex-col items-center justify-center px-4  md:flex-row lg:min-h-[100dvh] lg:px-20'>
      <div className='items flex flex-col items-center justify-center gap-6  md:flex-row-reverse '>
        ...
        <div className='flex h-full w-full flex-grow flex-col  gap-y-4 text-center md:gap-y-12'>
          <h2 className='text-xl font-bold lg:text-5xl'>Perks of Exploring with Us</h2>
