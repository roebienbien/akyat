...
export const PerksList: TPerks[] = [
  {
    ...
    description:
      "Explore Responsibly, Preserve Naturally – Your Adventure, Our Commitment to Conservation.",
  ...
  },
  {
    ...
    description:
      "Guided by Locals, Inspired by Nature – Experience Safety, Stories, and Scenic Wonders.",
    // description:
