        ...
        <div className="max-w-lg text-left lg:max-w-2xl">
          ...
          <span className="flex flex-col gap-y-4">
            <p className="mt-2 text-justify text-sm lg:text-base ">
              Whether you are from overseas or local, we can help you explore
              the 3142 summits of the Philippines. Akyat is your bridge that
              connects Lorem ipsum dolor sit amet.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Obcaecati, fuga. Perferendis nostrum quia aliquam reiciendis
              mollitia quisquam, voluptate architecto saepe! Lorem, ipsum dolor
              sit amet consectetur adipisicing elit. Facere, vel.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Obcaecati, fuga. Perferendis nostrum quia aliquam reiciendis
              mollitia quisquam, voluptate architecto saepe!
            </p>
          </span>
        </div>
        {/* Mobile FooterLinks */}
